...
// cleanly to one. Sourced from the shared constants file so this always
// matches the events filter bar.
...
const eventSchema = z
  .object({
    ...
    // Accepts either a full URL or a relative path like
    // "/uploads/events/<uuid>.jpg" (as returned by the image upload
    // endpoint, which is served from local disk and has no host/protocol).
    image_url: z
      .union([
